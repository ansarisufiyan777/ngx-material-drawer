...
export class GridContainerComponent implements OnInit {
  componentInstance = {
    c1: {
      ...
      data: { text: "I am the Blue C1 component" },
    },
    c2: {
      component: RedCardComponent,
      data: { text: "I am the Red C2 component" },
    },
    c3: {
      component: GreenCardComponent,
      data: { text: "I am the Green C3 component" },
    },
    c4: {
      component: BlueCardComponent,
      data: { text: "I am the Blue C4 component" },
    },
    c5: {
      component: RedCardComponent,
      data: { text: "I am the Red C5 component" },
    },
    c6: {
      component: GreenCardComponent,
      data: { text: "I am the Green C6 component" },
    },
  };
  gridData = {
    cols: 12,
