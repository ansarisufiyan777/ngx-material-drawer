import { Injectable, ɵɵdefineInjectable, ɵɵinject, Component, ViewChild, Input, Output, EventEmitter, HostBinding, NgModule, Directive, ViewContainerRef, ComponentFactoryResolver } from '@angular/core';
import { VERSION, MatRippleModule } from '@angular/material/core';
...
var NgxMaterialDrawerEventEmitter = /** @class */ (function () {
   ...
   */
    ...
    /** @nocollapse */ NgxMaterialDrawerEventEmitter.ngInjectableDef = ɵɵdefineInjectable({ factory: function NgxMaterialDrawerEventEmitter_Factory() { return new NgxMaterialDrawerEventEmitter(); }, token: NgxMaterialDrawerEventEmitter, providedIn: "root" });
...
var NgxNavService = /** @class */ (function () {
    ...
    /** @nocollapse */ NgxNavService.ngInjectableDef = ɵɵdefineInjectable({ factory: function NgxNavService_Factory() { return new NgxNavService(ɵɵinject(NgxMaterialDrawerEventEmitter)); }, token: NgxNavService, providedIn: "root" });
...
var NgxMaterialDrawerComponent = /** @class */ (function () {
    ...
    NgxMaterialDrawerComponent.propDecorators = {
        appDrawer: [{ type: ViewChild, args: ['appDrawer', { static: false },] }],
        navData: [{ type: Input, args: ['data',] }],
        onMatDrawerInit: [{ type: Output }],
        onMatDrawerAfterViewInit: [{ type: Output }],
        onNavStateChange: [{ type: Output }],
        onDataChange: [{ type: Output }],
        onSideNavOpen: [{ type: Output }],
        onSideNavClosed: [{ type: Output }],
        onMinVarientChange: [{ type: Output }],
        ...
        onSerachFocusIn: [{ type: Output }],
        onSerachFocusOut: [{ type: Output }],
        onSerachInputOpen: [{ type: Output }],
        onSerachInputClosed: [{ type: Output }],
        onFabExpanded: [{ type: Output }],
        onFabCollapsed: [{ type: Output }],
        onMainFabButtonClick: [{ type: Output }],
        onFabButtonClick: [{ type: Output }]
    };
...
var BreakpointObserverService = /** @class */ (function () {
    ...
    /** @nocollapse */ BreakpointObserverService.ngInjectableDef = ɵɵdefineInjectable({ factory: function BreakpointObserverService_Factory() { return new BreakpointObserverService(); }, token: BreakpointObserverService, providedIn: "root" });
...
export { NgxMaterialDrawerComponent, NgxMaterialDrawerEventEmitter, NgxMaterialDrawerModule, NgxNavService as ɵa, MaterialModule as ɵb, NgxNavListItemComponent as ɵc, NgxMenuListItemComponent as ɵd, NgxTopNavComponent as ɵe, NgxNavListItemMiniComponent as ɵf, NgxFabComponent as ɵg, NgxGridComponent as ɵh, BreakpointObserverService as ɵi, CardHolderComponent as ɵj, CardDirective as ɵk };
//# sourceMappingURL=ngx-material-drawer.js.map
